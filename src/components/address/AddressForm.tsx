          ...
          <div className={`flex flex-col md:flex-row gap-2 ${isMobile ? 'space-y-2 md:space-y-0' : ''}`}>
            <div className="flex-1">
              <Input 
                ...
                className="w-full" 
              />
              {postcode.trim().toUpperCase() === "ERROR" && (
            ...
            <Button 
              ...
              className={cn(
                isMobile ? 'w-full' : '', 
                !showAddresses ? 'bg-[#00CED1] hover:bg-[#00CED1]/90 text-black' : 'bg-white border border-gray-300 text-gray-500 hover:bg-gray-50'
              )} 
      ...
      <Dialog open={showErrorModal} onOpenChange={setShowErrorModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              We're experiencing technical difficulties with our address lookup service.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
