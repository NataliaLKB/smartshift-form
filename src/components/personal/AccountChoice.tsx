...
export const AccountChoice = ({
  ...
  return <div className="grid md:grid-cols-2 gap-6">
      <Card className="relative border-2 border-primary hover:border-primary/50 transition-colors cursor-pointer bg-primary/5" onClick={() => onSelect('account')}>
        <CardHeader>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">Get enhanced features and more detailed insights</p>
          ...
          <Button className="w-full mt-6" onClick={() => onSelect('account')}>
            Create an Account
          </Button>
        </CardContent>
      </Card>

      <Card className="relative border-2 hover:border-primary/50 transition-colors cursor-pointer" onClick={() => onSelect('guest')}>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
        ...
        <CardContent>
          ...
          <Button variant="outline" className="w-full mt-6" onClick={() => onSelect('guest')}>
            Continue as Guest
          </Button>
        </CardContent>
      </Card>
